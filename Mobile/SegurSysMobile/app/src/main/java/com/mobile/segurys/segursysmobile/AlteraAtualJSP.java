...
public class AlteraAtualJSP extends AsyncTask<Integer, Double, String> {
	private Activity ctx;
	private ProgressDialog progress;
	int totalReplicado = 0;

	public AlteraAtualJSP(AppCompatActivity ctx) {
		this.ctx = ctx;
	}
	...
	protected String doInBackground(Integer... params) {
        ...
        for (Atual at : atual) {
            ...
            strURL.append("http://192.168.43.209:8080/ProjetoWeb/alteraAtual.jsp?id_atual=");
