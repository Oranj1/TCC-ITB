...
public class RecebeRondaJSP extends AsyncTask<Integer, Double, String> {
	private Activity ctx;
	private ProgressDialog progress;

	public RecebeRondaJSP(Activity ctx) {
		this.ctx = ctx;
	}
	...
	protected String doInBackground(Integer... params) {
		...
		try {
			...
			String endereco = "http://192.168.43.209:8080/ProjetoWeb/listarRonda.jsp";
	    	...
	    	if (result.substring(i,i+1).equals("?")){ 
	    		{
		            ...
		            * matrizTela = separados.separaDados(LinhaDados, "|"); */
					...
					db.addRonda(Pos1, Pos2, Pos3, Pos4, Pos5);
	    		}    		
	    	}
	    } 
	}
